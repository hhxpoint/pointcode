...
export const BRIDGE_LOGIN_INSTRUCTION =
  'Remote Control requires PointCode account authentication and is unavailable in API-key mode.'

/** Full error printed when `claude remote-control` is run without auth. */
export const BRIDGE_LOGIN_ERROR =
  'Error: Remote Control is unavailable without account authentication.\n\n' +
