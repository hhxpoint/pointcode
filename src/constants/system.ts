...
const DEFAULT_PREFIX = `You are PointCode, an AI coding assistant CLI.`
const GENERIC_OPENAI_PREFIX = `You are an AI coding assistant running in a terminal CLI.
You help users with software engineering tasks including writing code, debugging, file operations, and git workflows.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are PointCode, an AI coding assistant CLI running within an agent SDK.`
const AGENT_SDK_PREFIX = `You are an AI agent, built on an agent SDK.`

const CLI_SYSPROMPT_PREFIX_VALUES = [
  DEFAULT_PREFIX,
  GENERIC_OPENAI_PREFIX,
