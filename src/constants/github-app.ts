export const PR_TITLE = 'Add PointCode GitHub Workflow'

export const GITHUB_ACTION_SETUP_DOCS_URL =
  'https://github.com/anthropics/claude-code-action/blob/main/docs/setup.md'

export const WORKFLOW_CONTENT = `name: PointCode
...
export const PR_BODY = `## 🤖 Installing PointCode GitHub App
...
export const CODE_REVIEW_PLUGIN_WORKFLOW_CONTENT = `name: PointCode Review
