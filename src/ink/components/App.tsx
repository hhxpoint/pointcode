...
export default class App extends PureComponent<Props, State> {
  ...
  // Keep Ink on the historical readable/read() path by default. The data
  // listener path remains opt-in for experimentation because Windows TTY
  // input and our suspend/early-input plumbing still assume readable mode.
  stdinMode: 'readable' | 'data' = process.env.OPENCLAUDE_USE_READABLE_STDIN === '0' ? 'data' : 'readable';
