    ...
    case "needsLogin":
      {
        ...
        if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
          t9 = <Box flexDirection="column"><Text dimColor={true}>Teleport requires account-authenticated cloud access.</Text><Text dimColor={true}>API-key mode does not support Teleport yet.</Text></Box>;
          $[16] = t9;
        } else {
          t9 = $[16];
        }
